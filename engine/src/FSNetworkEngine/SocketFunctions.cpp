...
_socket_connect_status connect_to_host(_HANDLE& fd, _CONST _CHAR* ipAddress, _CONST _UINT port, _CONST _INT timeout_second)
{
    ...
    getaddrinfo(ipAddress, _NULL, &hint, &result);
...
_LONG send_data(_HANDLE fd, _CONST _CHAR *binaryData,_LONG dataLength)
{
#ifdef MY_DEBUG
...
_LONG receive_data(_HANDLE fd, _CONST _CHAR *binaryData, _LONG &dataLength)
{
...
_BOOL disconnect_socket(_HANDLE fd)
{
